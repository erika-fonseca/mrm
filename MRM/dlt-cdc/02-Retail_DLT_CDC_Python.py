...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/8de430ea-762c-4041-bbd5-d3dc221ae8df">Delta Live Table Pipeline for CDC</a>.
...
# MAGIC -- display(spark.read.json("/Volumes/dbdemos/dbdemos_dlt_cdc/raw_data/customers"))
...
# MAGIC %md
# MAGIC ## Conclusion 
# MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/8de430ea-762c-4041-bbd5-d3dc221ae8df">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="dlt-expectations" href='/sql/dashboardsv3/01ef906d35671a9cbce0dd175b78aa7d'  target="_blank">Data Quality Dashboard</a>
